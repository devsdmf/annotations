...
/**
 * Class ReflectionObjectAdapter
 *
 * The adapter for ReflectionObject instances
 *
 ...
 */
class ReflectionObjectAdapter extends ReflectionClassAdapter implements AdapterInterface
{
}